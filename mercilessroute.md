...
- Muffet dies in 1 decently timed hit (perfect hit is around 2300, she has 1250.) You should now have 5 kills.

- Buy the Empty Gun and Cowboy Hat outside the MTT hotel, equip them, then put all items besides anything for Sans (Sea Tea or Noodles) in the box.

- Take the elevator and grind 28 more encounters in the room just left of where you end up to have 33 total.

- Everything but Knights and Madjick can be killed in 1 hit (you can kill them with a 4 gold/perfect hit, but this is incredibly inconsistent.) Some people grind the last encounter to reach 33 total 2 rooms before the bridge, this is optional.

- Go up to the bridge to get your last 7 (all scripted) encounters.

- Go back to Mettaton (if you counted right you'll get 2 but nobody came before you reach him) and 1 shot him from anywhere.

- Heal outside new house, mash through all Flowey's text, everything can be skipped to reach Sans.

Enemy | `DECIMATE` | Notes
:---- | :---- | :----
...
Enemy | `ACT` | INPUT LOCATION | Notes
:---- | :---- | :---- | :----
...
Shyren | `Flee` |
Temmie | `fLE E!!` |
Undyne | `CHALLENGE ↓ for 4 turns, then for 3 |
...
Enemy | `ACT` | INPUT LOCATION | Notes
:---- | :---- | :---- | :----
Royal Guards | `RG02 Clean Armor+RG01 Whisper` | Z ↓ Z ↓ +  Z → |
...
Order | INPUT/ACT LOCATION
:---- | :----
Death Note (Lower Left) | → 
Blue Note (Right) | →
Gift (Up) | MASH!!!!
Basketbomb | MASH!!!!
Dog | →
...
Enemy | `ACT` | INPUT LOCATIONS | Notes
:---- | :---- | :---- | :----
